...
import com.latam.cmz.hotelalura.dao.UsuarioDAO;
...
public class Login extends JFrame {
	...
	public Login() {
		...
		imgHotel.setIcon(DirectorioImg.ico("img-hotel-login-.png"));
		...
		lblNewLabel_1.setIcon(DirectorioImg.ico("lOGO-50PX.png"));
	...
	private void AutenticarLogin() {
		 String LogUser= txtUsuario.getText();
	     String LogPass= new String (txtContrasena.getPassword());
	     boolean LogUserOK=false;
	     boolean LogPassOK=false;
	     Usuario LogUsuario=null;
	     
	     
	     if (LogUser.equals("Ingrese su nombre de usuario")||LogUser.isEmpty()) {
	    	 JOptionPane.showMessageDialog(EstaVentana, "Favor Ingresar su usuario");
	    	 txtUsuario.grabFocus();
	    	 return;
	     }
	     if (LogUser.isEmpty()||LogUser.isBlank()) {
	    	 JOptionPane.showMessageDialog(EstaVentana, "Favor Ingresar su contraseña");
	        ...
	        for (Usuario u:Usuarios) {
				if(u.getUsuario().equals(LogUser)) {
					LogUserOK=true;
					if(u.getContraseña().equals(LogPass)) {
						LogPassOK=true;
						LogUsuario=u;
						}
					break;
	        ...
	        if (LogUserOK) {
	        	if (LogPassOK) {
	        		MenuUsuario menu = new MenuUsuario(LogUsuario);
		            menu.setVisible(true);
		            dispose();
	        	}else {
		            JOptionPane.showMessageDialog(EstaVentana, "Contraseña no válida");
		            txtContrasena.grabFocus();
		            txtContrasena.setText("");
					txtContrasena.setForeground(Color.black);		            
		        }
	            ...
	            JOptionPane.showMessageDialog(EstaVentana, "Usuario no válido");
	            txtUsuario.grabFocus();
	            txtUsuario.setText("Ingrese su nombre de usuario");
	            txtUsuario.setForeground(Color.gray);
	        }
